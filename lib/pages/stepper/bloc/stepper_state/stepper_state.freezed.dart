...
mixin _$StepperState {
 ...
 List<TextFieldInput> get verificationFieldsStepper; TextFieldInput get employeeIdStepper; int get currentStep; RequestStatus get requestStatus;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(verificationFieldsStepper),employeeIdStepper,currentStep,requestStatus);

@override
String toString() {
  return 'StepperState(verificationFieldsStepper: $verificationFieldsStepper, employeeIdStepper: $employeeIdStepper, currentStep: $currentStep, requestStatus: $requestStatus)';
}
...
@useResult
$Res call({
 List<TextFieldInput> verificationFieldsStepper, TextFieldInput employeeIdStepper, int currentStep, RequestStatus requestStatus
});
...
/// Create a copy of StepperState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? verificationFieldsStepper = null,Object? employeeIdStepper = null,Object? currentStep = null,Object? requestStatus = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<TextFieldInput> verificationFieldsStepper,  TextFieldInput employeeIdStepper,  int currentStep,  RequestStatus requestStatus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StepperState() when $default != null:
return $default(_that.verificationFieldsStepper,_that.employeeIdStepper,_that.currentStep,_that.requestStatus);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<TextFieldInput> verificationFieldsStepper,  TextFieldInput employeeIdStepper,  int currentStep,  RequestStatus requestStatus)  $default,) {final _that = this;
switch (_that) {
case _StepperState():
return $default(_that.verificationFieldsStepper,_that.employeeIdStepper,_that.currentStep,_that.requestStatus);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<TextFieldInput> verificationFieldsStepper,  TextFieldInput employeeIdStepper,  int currentStep,  RequestStatus requestStatus)?  $default,) {final _that = this;
switch (_that) {
case _StepperState() when $default != null:
return $default(_that.verificationFieldsStepper,_that.employeeIdStepper,_that.currentStep,_that.requestStatus);case _:
  return null;
...
class _StepperState implements StepperState {
  const _StepperState({final  List<TextFieldInput> verificationFieldsStepper = const [], this.employeeIdStepper = const TextFieldInput(errorType: ErrorType.empty), this.currentStep = 0, this.requestStatus = RequestStatus.waiting}): _verificationFieldsStepper = verificationFieldsStepper;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_verificationFieldsStepper),employeeIdStepper,currentStep,requestStatus);
...
/// Create a copy of StepperState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? verificationFieldsStepper = null,Object? employeeIdStepper = null,Object? currentStep = null,Object? requestStatus = null,}) {
