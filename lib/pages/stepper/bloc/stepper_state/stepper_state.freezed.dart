...
mixin _$StepperState {
 ...
 List<TextFieldInput> get verificationFieldsStepper; TextFieldInput get employeeIdStepper; int get currentStep; bool get isCheckedTermsPriv; RequestStatus get requestStatus; RequestStatus get requestStatusSendOtpStepper; RequestStatus get requestStatusVerifyOtpStepper; String get message; bool get verificationStepInitialized;
...
@useResult
$Res call({
 List<TextFieldInput> verificationFieldsStepper, TextFieldInput employeeIdStepper, int currentStep, bool isCheckedTermsPriv, RequestStatus requestStatus, RequestStatus requestStatusSendOtpStepper, RequestStatus requestStatusVerifyOtpStepper, String message, bool verificationStepInitialized
});
...
/// Create a copy of StepperState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? verificationFieldsStepper = null,Object? employeeIdStepper = null,Object? currentStep = null,Object? isCheckedTermsPriv = null,Object? requestStatus = null,Object? requestStatusSendOtpStepper = null,Object? requestStatusVerifyOtpStepper = null,Object? message = null,Object? verificationStepInitialized = null,}) {
...
as String,verificationStepInitialized: null == verificationStepInitialized ? _self.verificationStepInitialized : verificationStepInitialized // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of StepperState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<TextFieldInput> verificationFieldsStepper,  TextFieldInput employeeIdStepper,  int currentStep,  bool isCheckedTermsPriv,  RequestStatus requestStatus,  RequestStatus requestStatusSendOtpStepper,  RequestStatus requestStatusVerifyOtpStepper,  String message,  bool verificationStepInitialized)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StepperState() when $default != null:
return $default(_that.verificationFieldsStepper,_that.employeeIdStepper,_that.currentStep,_that.isCheckedTermsPriv,_that.requestStatus,_that.requestStatusSendOtpStepper,_that.requestStatusVerifyOtpStepper,_that.message,_that.verificationStepInitialized);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<TextFieldInput> verificationFieldsStepper,  TextFieldInput employeeIdStepper,  int currentStep,  bool isCheckedTermsPriv,  RequestStatus requestStatus,  RequestStatus requestStatusSendOtpStepper,  RequestStatus requestStatusVerifyOtpStepper,  String message,  bool verificationStepInitialized)  $default,) {final _that = this;
switch (_that) {
case _StepperState():
return $default(_that.verificationFieldsStepper,_that.employeeIdStepper,_that.currentStep,_that.isCheckedTermsPriv,_that.requestStatus,_that.requestStatusSendOtpStepper,_that.requestStatusVerifyOtpStepper,_that.message,_that.verificationStepInitialized);}
}
...
class _StepperState implements StepperState {
  const _StepperState({final  List<TextFieldInput> verificationFieldsStepper = const [], this.employeeIdStepper = const TextFieldInput(errorType: ErrorType.empty), this.currentStep = 0, this.isCheckedTermsPriv = false, this.requestStatus = RequestStatus.waiting, this.requestStatusSendOtpStepper = RequestStatus.waiting, this.requestStatusVerifyOtpStepper = RequestStatus.waiting, this.message = '', this.verificationStepInitialized = false}): _verificationFieldsStepper = verificationFieldsStepper;
...
@override@JsonKey() final  bool verificationStepInitialized;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_verificationFieldsStepper),employeeIdStepper,currentStep,isCheckedTermsPriv,requestStatus,requestStatusSendOtpStepper,requestStatusVerifyOtpStepper,message,verificationStepInitialized);
...
/// Create a copy of StepperState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? verificationFieldsStepper = null,Object? employeeIdStepper = null,Object? currentStep = null,Object? isCheckedTermsPriv = null,Object? requestStatus = null,Object? requestStatusSendOtpStepper = null,Object? requestStatusVerifyOtpStepper = null,Object? message = null,Object? verificationStepInitialized = null,}) {
